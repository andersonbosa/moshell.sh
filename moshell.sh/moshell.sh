...
export _MOSHEL_DIR_BASE_PATH=$ABSOLUTE_PATH_TO_THIS_FILE
export _MOSHEL_DIR_CORE="$_MOSHEL_DIR_BASE_PATH/core"
export _MOSHEL_DIR_PLUGINS="$_MOSHEL_DIR_BASE_PATH/plugins"
export _MOSHEL_DIR_CUSTOM="$_MOSHEL_DIR_BASE_PATH/custom"
